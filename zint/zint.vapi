namespace Zint
{
	...
	public class Symbol
	{
		...
		[CCode (cname = "ZBarcode_Encode_and_Buffer")]
		public int Encode_and_Buffer(string input, int length, int rotate_angle);
		
		[CCode (cname = "ZBarcode_ValidID")]
		public int ValidID(int symbol_id);
	}
	namespace Barcode
	{
        ...
        [CCode (cheader_filename = "zint.h", cname="UNICODE_MODE")]
        public const int UNICODE_MODE;
	}
}
