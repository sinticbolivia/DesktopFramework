/* GtkSinticBolivia.vapi generated by valac 0.54.7, do not modify. */
...
namespace SinticBolivia {
	namespace Gtk {
		...
		public class GtkHelper : GLib.Object {
			...
			public static global::Gtk.Builder GetGladeUIFromResource (GLib.Resource res, string glade_ui = "");
			public static GLib.InputStream GetInputStreamFromResource (GLib.Resource res, string file);
		...
		public abstract class SBGtkModule : SinticBolivia.SBModule {
			...
			protected SBGtkModule ();
			public global::Gtk.Builder GetGladeUi (string ui_file, string t_domain = "");
